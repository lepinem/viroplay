...
import ViroTheater from '../components/ViroTheater'
      ...
      <ViroAmbientLight color="#ffffff" intensity={200}/>
        ...
        <ViroPortalScene passable={true} dragType="FixedDistance" onDrag={()=>{}}>
          <ViroPortal position={[0, 0, -1]} scale={[.5, .5, .5]}>
            <Viro3DObject source={require('./portal_res/portal_window_frame/portal_window_frame.vrx')}
              resources={[require('./portal_res/portal_window_frame/portal_window_frame_diffuse.png'),
                          require('./portal_res/portal_window_frame/portal_window_frame_normal.png'),
                          require('./portal_res/portal_window_frame/portal_window_frame_specular.png')]}
              type="VRX"/>
          </ViroPortal>
          {/* <ViroTheater /> */}
